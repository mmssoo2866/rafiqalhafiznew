...
export const MURTAGAS: MurtagaInfo[] = [
  { id: 1, name: "����� �����", startSurahId: 114, endSurahId: 67 },
  { id: 2, name: "����� �", startSurahId: 66, endSurahId: 50 },
  { id: 3, name: "����� �����", startSurahId: 49, endSurahId: 39 },
  { id: 4, name: "����� �����", startSurahId: 38, endSurahId: 27 },
  { id: 5, name: "����� �����", startSurahId: 26, endSurahId: 18 },
  { id: 6, name: "����� ����", startSurahId: 17, endSurahId: 10 },
  { id: 7, name: "����� �������", startSurahId: 9, endSurahId: 5 },
  { id: 8, name: "����� �������", startSurahId: 4, endSurahId: 1 }
];
